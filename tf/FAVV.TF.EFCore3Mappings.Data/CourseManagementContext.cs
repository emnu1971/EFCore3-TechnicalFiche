...
namespace FAVV.TF.EFCore3Mappings.Data
{
    /// <summary>
    ...
    public class CourseManagementContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Configure mappings for Disenrollment entity
            modelBuilder.ApplyConfiguration<Disenrollment>(new DisenrollmentEntityConfiguration());
    ...
    public class DisenrollmentEntityConfiguration : IEntityTypeConfiguration<Disenrollment>
    {
        ...
        {
            disenrollment.ToTable("Disenrollments");
            disenrollment.HasKey(d => new { d.CourseId, d.StudentId });
        }
    }
